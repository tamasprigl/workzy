    ...
    <main className="bg-black text-white">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-6 text-center">
        ...
        <p className="text-lg md:text-xl text-gray-400 mb-10 max-w-2xl">
          Automatizált toborzás és álláskeresés egy platformon.
          Találd meg a megfelelő embert vagy a következő munkád gyorsabban, mint valaha.
        </p>
      ...
      <section className="py-20 px-6 max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
        ...
        <div className="bg-gray-900 p-6 rounded-2xl">
          ...
          <p className="text-gray-400">Jelentkezz egy kattintással, egyszerűen.</p>
        </div>

        <div className="bg-gray-900 p-6 rounded-2xl">
          <h3 className="text-xl font-semibold mb-2">AI alapú párosítás</h3>
          <p className="text-gray-400">Automatikusan összekötünk a legjobb lehetőségekkel.</p>
        </div>

        <div className="bg-gray-900 p-6 rounded-2xl">
          <h3 className="text-xl font-semibold mb-2">Gyors felvétel</h3>
          <p className="text-gray-400">Munkaadóknak: kevesebb HR, több eredmény.</p>
        </div>
