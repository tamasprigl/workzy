    ...
    allApplicantRecords = filteredApps.map((rec) => {
      ...
      return {
        ...
        message:
          ...
          "-",
        status: (() => {
          const rawStatus = getFirstString(rec.get("Status")) || getFirstString(fields["Status"]);
          const status = rawStatus || "Új";
          return status;
        })(),
                  ...
                  <div className="grid gap-4 rounded-[22px] bg-white/96 p-4 lg:grid-cols-[42px_1.1fr_1.2fr_1.2fr_auto] lg:items-center">
                    ...
                    <div>
                      ...
                      <div className="mt-2 flex flex-wrap items-center gap-3">
                        ...
                        <ApplicationStatusSelect recordId={applicant.id} currentStatus={applicant.status} />
                      </div>
                    </div>
